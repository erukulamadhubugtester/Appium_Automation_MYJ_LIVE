...
profiles:
	...
	pytest tests/test_profiles.py \
	  --html=$(RESULTS_DIR)/tests/test_profiles.py_report.html --self-contained-html \
	  --alluredir=$(RESULTS_DIR)/profiles_allure
	$(call OPEN_REPORT,profiles_report.html)

profiles_scroll:
	$(CLEAN_RESULTS)
	pytest tests/test_profiles_data_scroll_page.py \
	  --html=$(RESULTS_DIR)/tests/test_profiles.py_report.html --self-contained-html \
	  --alluredir=$(RESULTS_DIR)/profiles_scroll_allure
