...
LOCATORS = {
    ...
    "RR_BALANCE_VALUE": (
        AppiumBy.XPATH,
        '//android.widget.TextView[@text="Balance"]/following-sibling::android.widget.TextView',
    ),
    # 6. "Points" label
    "RR_POINTS_LABEL": (
        AppiumBy.XPATH,
    ...
    # 10. Referral code example (exact). Use only for fixed demo values
    "RR_REF_CODE_EXACT": (
        AppiumBy.XPATH,
        '//android.widget.TextView[@text="y15JPO"]',
    ),
    # 11. Referral code generic (dynamic – recommended)
    "RR_REF_CODE_GENERIC": (
        AppiumBy.XPATH,
        '//android.widget.TextView[contains(@text,"")]',
    ),
    # ✅ unified key used inside page file
    "RR_REFERRAL_CODE": (
        AppiumBy.XPATH,
        '//android.widget.TextView[contains(@text,"")]',
    ),
    ...
    "THREE_DOTS_MENU": ["xpath", "//android.widget.TextView[@text='']"],
    "REWARDS_POLICY_MENU": [
        "xpath",
        "//android.view.ViewGroup[@content-desc=', Rewards and Referrals policy']",
    ],
    "REWARDS_POLICY_TITLE": [
        "xpath",
        "//android.widget.TextView[@text='Rewards and Referrals Policy']",
    ],
    "REWARDS_POLICY_NUMBER": [
        "xpath",
        "//android.widget.TextView[starts-with(@text,'1.')]",
    ],
    "REWARDS_POLICY_TEXT": [
        "xpath",
        "//android.widget.TextView[contains(@text,'If you refer someone')]",
    ],
    "BACK_ARROW": ["xpath", "//android.widget.TextView[@text='']"],
    "REWARDS_HISTORY_TEXT": [
        "xpath",
        "//android.widget.TextView[@text='Rewards redemption history']",
    ],
    "REWARDS_HISTORY_MENU": [
        "xpath",
        "//android.view.ViewGroup[@content-desc='Rewards redemption history, ']",
    ],
    "REWARDS_HISTORY_TITLE": [
        "xpath",
        "//android.widget.TextView[@text='Rewards Redemption History']",
    ],
    ...
    "HISTORY_ITEM_TEXT": [
        "xpath",
        "//android.widget.TextView[contains(@text,'Points credited')]",
    ],
    "HISTORY_ITEM_TIME": ["xpath", "//android.widget.TextView[contains(@text,',')]"],
    "HISTORY_ITEM_POINTS": ["xpath", "//android.widget.TextView[contains(@text,'+')]"],
    ...
    "PROFILES_ICON": (
        AppiumBy.XPATH,
        '//android.view.View[@content-desc="Profiles"]/android.widget.ImageView',
    ),
    "PROFILES_TEXT": (
        AppiumBy.XPATH,
        '(//android.widget.TextView[@text="Profiles"])[1]',
    ...
    "RECENT_VISITORS_TAB": (
        AppiumBy.XPATH,
        '//android.view.View[@content-desc="Recent Visitors"]/android.view.ViewGroup/android.view.ViewGroup',
    ),
    "PROMOTED_TAB": (
        AppiumBy.XPATH,
        '//android.view.View[@content-desc="Promoted"]/android.view.ViewGroup/android.view.ViewGroup',
    ),
    "PREFERRED_TAB": (AppiumBy.XPATH, '//android.widget.TextView[@text="Preferred"]'),
    # ---- Generic Profile Cards ----
    # Match any text that contains "yrs" (for Name + Age)
    "PROFILE_NAME_AGE": (
        AppiumBy.XPATH,
        '//android.widget.TextView[contains(@text,"yrs")]',
    ),
    # Match location dynamically → assuming location is shown below name in TextView
    # This takes all visible TextViews inside profile cards (not hardcoded to Haryana/UP)
    "PROFILE_LOCATIONS": (
        AppiumBy.XPATH,
        '//android.widget.TextView[not(contains(@text,"yrs")) and @text!="Preferred" and string-length(text())>1]',
    ),
    # ---- Free user case ----
    "UPGRADE_PLAN_BUTTON": (
        AppiumBy.XPATH,
