...
LOCATORS = {
    ...
    "PROFILE_POPUP_TITLE": (AppiumBy.XPATH, "//android.widget.TextView[@text='Complete Your Profile']"),
    "PROFILE_POPUP_CONTENT": (AppiumBy.XPATH, "//android.widget.TextView[@text='Get the best matches and boost your visibility on our platform by completing your profile and sharing more about yourself.']"),
    "PROFILE_POPUP_PROGRESS": (AppiumBy.XPATH, "//android.widget.TextView[contains(@text,'%')]"),
    "PROFILE_POPUP_COMPLETE_BTN": (AppiumBy.XPATH, "//android.view.ViewGroup[@content-desc='Complete Profile']"),
    "PROFILE_POPUP_SKIP_BTN": (AppiumBy.XPATH, "//android.view.ViewGroup[@content-desc='Skip for Now']"),
    # ========= Home page  locators ==================================#
    # Home icons
