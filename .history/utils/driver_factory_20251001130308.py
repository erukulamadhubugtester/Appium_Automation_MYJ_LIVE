...
def create_driver(use_emulator=True):
    ...
    caps = {
        ...
        "udid": device_name,  # 👈 Make sure it connects to the exact device
        "automationName": "UiAutomator2",
        "appPackage": "com.meriteye.makeyourjodi",
        "appActivity": ".MainActivity",
        "noReset": False,
...
def create_driver(use_emulator=True):
    ...
    # Create capabilities via UiAutomator2Options
    ...
    # Start Appium driver — no desired_capabilities argument!
