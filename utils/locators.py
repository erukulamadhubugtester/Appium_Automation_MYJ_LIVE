...
LOCATORS = {
    ...
    # ---- Profile cards ----
    # Each card has a content-desc with name+age
    "PROFILE_CARD": (
        AppiumBy.XPATH,
        '//android.view.ViewGroup[@content-desc and contains(@content-desc,"yrs")]',
    ),
    # Inside card: first textview = location
    "PROFILE_LOCATION_REL": (AppiumBy.XPATH, ".//android.widget.TextView[1]"),
    # ---- Free user case ----
    "UPGRADE_PLAN_BUTTON": (
        AppiumBy.XPATH,
